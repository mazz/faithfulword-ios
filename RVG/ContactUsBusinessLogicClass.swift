...
class ContactUsBusinessLogicClass {
    ...
    func checkValidations(obj:ContactUsVc){
        ...
        if !((obj.txtName.text?.characters.count)!>0){
            if language == "english"{
                obj.showSingleButtonAlertWithoutAction(title: "Please fill out your name")
            }else{
                obj.showSingleButtonAlertWithoutAction(title: "Por favor escribe tu nombre")
            }
        }else if !((obj.txtEmail.text?.characters.count)!>0){
            if language == "english"{
                obj.showSingleButtonAlertWithoutAction(title: "Please fill out your email address")
            }else{
            ...
            if language == "english"{
                obj.showSingleButtonAlertWithoutAction(title: "Please fill out your message")
            }else{
    ...
    func hitService(obj:ContactUsVc){
        ...
        WebServiceSingleTon().PostRequest(params: params as NSDictionary, linkUrl: contactUs, indicator: true, success: { (data) in
            ...
            if language == "english"{
                obj.showSingleButtonAlertWithoutAction(title: "Thank you, we will contact you soon")
            }else{
