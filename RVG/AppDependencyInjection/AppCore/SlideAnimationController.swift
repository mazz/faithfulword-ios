...
public class SlideOpenAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
...
public class SlideClosedAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    public func transitionDuration(using transitionContext: UIViewControllerContextTransitioning?) -> TimeInterval {
        return duration
    }
