...
class BaseTableViewController: UITableViewController {
    ...
    public var viewModelSearchSections: [MediaListingSectionViewModel] = []
    ...
    func configureCell(_ cell: UITableViewCell, forPlayable playable: Playable) {
        
        
        cell.textLabel?.text = playable.localizedname
...
//        let priceString = numberFormatter.string(from: NSNumber(value: product.introPrice))
        ...
        cell.detailTextLabel?.text = playable.presenterName
    }
}
