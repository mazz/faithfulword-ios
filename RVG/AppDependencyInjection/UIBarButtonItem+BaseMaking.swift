...
public extension UIBarButtonItem {
    public static func close() -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "temp_x"),
                               style: .plain,
                               target: nil,
                               action: nil)
    }
...
//        return UIBarButtonItem(image: UIImage.uiAsset(name: "myBose-dark"),
//                               style: .plain,
//                               target: nil,
//                               action: nil)
//    }
...
//                                   action: nil)
//
//        let normalTitleAttributes = [NSAttributedStringKey.font: UIFont.dynamicBoseFont(.bold, .caption1),
...
//
//        let highlightedTitleAttributes = [NSAttributedStringKey.font: UIFont.dynamicBoseFont(.bold, .caption1),
...
//    }
    ...
    public static func back() -> UIBarButtonItem {
        return UIBarButtonItem(image: UIImage(named: "icLeftChevron"),
                               style: .plain,
                               target: nil,
                               action: nil)
    }
