...
public struct Music: Codable, Categorizable {
    var userId: Int
...
extension Music: FetchableRecord { }
...
extension Music: MutablePersistableRecord {
    public static let databaseTableName = "music"
